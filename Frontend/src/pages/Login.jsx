...
import { Github, Zap, Shield, GitPullRequest, Terminal, Bot } from 'lucide-react'
...
export default function Login() {
  return (
    <div className="min-h-screen bg-canvas flex items-center justify-center relative overflow-hidden font-poppins">
      ...
      {/* Glow orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full pointer-events-none" style={{background:'radial-gradient(circle,rgba(63,185,80,0.07) 0%,transparent 70%)'}}/>
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 rounded-full pointer-events-none" style={{background:'radial-gradient(circle,rgba(88,166,255,0.05) 0%,transparent 70%)'}}/>

      <div className="relative z-10 text-center max-w-lg px-6 animate-fade-in">
        {/* Logo */}
        <div className="inline-flex items-center gap-3 mb-10">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{background:'linear-gradient(135deg,#238636,#1a7f37)',boxShadow:'0 0 24px rgba(63,185,80,0.4)'}}>
            <Zap size={22} color="#fff" fill="#fff"/>
          </div>
          <div className="text-left">
            <div className="text-xl font-bold tracking-tight text-fg-default">DevFlow AI</div>
            <div className="text-xs text-fg-muted -mt-0.5">Online Code Editor</div>
          </div>
        </div>
        ...
        <p className="text-fg-muted text-base leading-relaxed mb-10">
          Browser IDE with AI assistant, bug scanner,<br/>CI/CD monitor and PR review — all in one place.
        </p>
